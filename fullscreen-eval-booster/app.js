...
try {
  ...
  if (typeof FollowAnalyticsParams === 'undefined') {
    throw 'Missing template parameters, shutting down.';
  }
    ...
    const allPages = [
      {
        ...
        value: _.first(FollowAnalyticsParams.rating_page),
        buttonsDisabled: false,
      },
      {
        id: 'page-pos',
        label: 'Positive Feedback Page',
        value: _.first(FollowAnalyticsParams.positive_feedback_page),
        buttonsDisabled: false,
      },
      {
        id: 'page-neg',
        label: 'Negative Feedback Page',
        value: _.first(FollowAnalyticsParams.negative_feedback_page),
        buttonsDisabled: false,
      },
    ];
    _.forEach(allPages, (pageObj) => {
      const page = pageObj.value;
      // Background config
